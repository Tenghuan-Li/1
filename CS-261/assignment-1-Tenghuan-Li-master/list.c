...
//  new_link->val = malloc( sizeof( void* ) );
//  new_link->next = NULL;
//  new_list->head = new_link;
  return new_list;
}
...
void list_free(struct list* list) {
  struct link* point1;
//  struct link* point2;
  for(point1=list->head;point1->next!=NULL;){
  	struct link* point2;
  	point2 = point1;
  	point1=point1->next;
  	free(point2);  	
...
void list_remove(struct list* list, void* val, int (*cmp)(void* a, void* b)) {
  struct link* point1 = list->head;
  struct link* point2 = list->head;
  for(point2=point1;point1->next!=NULL;point1=point1->next){
  	//if p1=p2=list->head and val need be remove? 
  	if((*cmp)(point1->val,val)==0){
...
//  point1=list->head;
  int sum=0;
/*  for(point1=list->head;point1->next!=NULL;point1=point1->next){
  	if((*cmp)(val,point1->val)==0){
  		return sum;
  		break;
	  }else
	  	sum++;
...
*/
for(point1=list->head;point1!=NULL;point1=point1->next){
  	if((*cmp)(val,point1->val)==0){
  		return sum;
  		break;
	  }else
